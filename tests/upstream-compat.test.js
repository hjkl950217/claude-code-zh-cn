...
test("production upstream compat config guards issue #80 visible native residues", () => {
  ...
  assert.deepEqual(
    [
      ...
      "issue80_batch_command_description",
      "issue80_claude_in_chrome_command_description",
      ...
      "issue122_advisor_short_description",
      "issue122_autocompact_short_description",
      "issue122_batch_menu_description",
      "issue122_claude_api_menu_description",
      "issue122_claude_in_chrome_menu_description",
      "issue122_config_short_description",
      "issue122_daemon_short_description",
      "issue122_debug_menu_description",
      "issue122_design_sync_menu_description",
      "issue122_fewer_permission_prompts_menu_description",
      "issue122_focus_short_description",
      "issue122_goal_short_description",
      "issue122_keybindings_short_description",
      "issue122_loops_short_description",
      "issue122_memory_short_description",
      "issue122_permissions_short_description",
      "issue122_remote_control_short_description",
      "issue122_remote_env_short_description",
      "issue122_schedule_short_description",
      "issue122_schedule_menu_description",
      "issue122_run_menu_description",
      "issue122_run_skill_generator_menu_description",
      "issue122_simplify_menu_description",
      "issue122_tasks_short_description",
      "issue122_ultraplan_short_description",
      "issue122_ultrareview_short_description",
      "issue122_version_short_description",
      "issue122_web_setup_short_description",
      "issue122_workflows_short_description",
      "issue122_commit_pr_prompt_description",
      "issue122_update_config_menu_description",
      "issue122_loop_menu_description",
      "issue122_cowork_plugin_long_description",
      "issue122_design_sync_long_description",
      "issue122_claude_api_long_description",
      "issue122_run_long_description",
      "issue122_run_skill_generator_long_description",
      "issue122_verify_skill_description",
    ].filter((id) => !guardIds.has(id)),
    []
  );
});
