...
- ✅ 已验证版本直接使用公开证据；更高 native 版本也先本机自检。可 patch 硬编码文字（2070 条翻译；代表版本 `2.1.112` 实测 1699 处有效 patch）
...
| UI 文字中文化 | 2070 条翻译，`2.1.112` 实测 1699 处有效 patch | CLI Patch（扫描真实双引号字符串 token 后逐条替换）+ 显示面审计 |
